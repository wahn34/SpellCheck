...
public class PopSpellActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_spell);
        final EditText editInputText = (EditText) findViewById(R.id.edText);
        final TextView txtResultView = (TextView) findViewById(R.id.txView);
        list = (ListView) findViewById(R.id.lstSpellPopChks);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    if (dbHelper == null) {
                        dbHelper = new DBHelper(PopSpellActivity.this, "SPELL_WORD", null, 1);
                    }
        ...
        Button btnPopClib = (Button) findViewById(R.id.btnPopClib);
        btnPopClib.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button btnClickConvert = (Button) findViewById(R.id.btnClickConvert);
        btnClickConvert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    //ifMethodSuccess = 1;
